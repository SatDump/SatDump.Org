...
After a very long time and many struggles (including a very annoying language issue that kept us stuck for days - more on that later) we are very proud to announce infrared calibration for Meteor-M satellites on HRPT (LRPT is still in the works). 
