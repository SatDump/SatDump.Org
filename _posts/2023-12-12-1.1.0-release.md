...
- A potential bug with NOAA DSB
- Quite a few fixes about SIMD handling that could cause crashes on machines without AVX2
- A bug that could make M&M clock recovery crash if too little data was provided
- Fix FY-2 S-VISSR decoder discarding partial scans
