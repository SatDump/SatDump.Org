...
Support for HRPT and LRPT was added. After it was decovered that it activated the MTVZA instrument, 
...
After Scott Tilley and Amsat-DL provided a nice baseband file of the DSCOVR signal, a image decoder was added.
...
Since N15 is going through a rough phase at the moments, RAD750 decided to send it some love by adding a "in orbit since" counter.
