...
Thanks to some lucky findings by OK9UWU and his data, Aang23 was able to decode the XRT/EIS instruments on the Hinode / Solar-B satellite. Right now, all data is transmitted on S-Band, and it dumps to ground stations all over the world. With some more data, we hope to add SOHO and SUVI support for this satellite as well.
...
- Total number of times we publically said "Oops": **15**
