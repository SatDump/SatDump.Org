...
- **CIR (Color Infrared):** CIR is perhaps the most widely used enhancement for earth observation. It has its roots from aerial orthophotography, as it shows contours as well as vegetation better and also avoids using the blue band which is affected by scattering.
