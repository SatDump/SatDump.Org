...
This became a problem when SatDump started growing outside of Western and Eastern Europe, as most composites tended to "break" in unexpected ways when exposed to a different geomorphology such as when a significant portion of the image is occupied by the Sahara Desert.

[IMAGE]

With the introduction of calibrated imagery, the infrared portion got an in-depth overhaul with many useful composites and products such as Cloud Top IR, Night Microphysics and more. However, the daytime composites using mostly visible were not really touched up more than strictly necessary, given that for most people they were
