...
SatDump can now extract SSMIS data from the DMSP RTD direct-broadcast link. Some work is still needed to get projections and potentially calibration running however. This was prompted by the now cancelled plans to discontinue distribution of SSMIS data.
